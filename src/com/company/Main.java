...
public class Main extends Application {
    ...
    public static int dotSize = 10; // display var

    public static float satisfaction = 0.6f; // needed satisfaction
    public static int emptyProcent = 5; // the percentage of plots which is set as empty
    ...
    public void updateWorld () // updates world;
    {
        ...
        if (unsatisfied == 0) System.out.println("Everyone is satisfied!");
    }
